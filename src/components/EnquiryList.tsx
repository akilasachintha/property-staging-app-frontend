...
import {EnquiryType, useDashboardContext} from '../context/DashboardContext';
...
const EnquiryList: FC<EnquiryListProps> = ({rowsCount}) => {
    ...
    const {enquiryList} = useDashboardContext();
    const {onOpen} = useDashboardContext();
    ...
    return (
        <div className="w-full overflow-x-auto bg-white rounded shadow-lg p-4">
            ...
            {currentItems && currentItems.length > 0 && currentItems.map((inquiry, index) => (
                <div key={index}
                    ...
                    <div className="text-[0.8rem]">{inquiry.id}</div>
                    <div className="sm:hidden font-bold">Client Name:</div>
                    <div className="text-[0.8rem] font-bold">{inquiry.clientName}</div>
                    <div className="sm:hidden font-bold">Property Address:</div>
                    <div className="text-[0.8rem]">{inquiry.propertyAddress}</div>
                    <div className="sm:hidden font-bold">Submission Date:</div>
                    <div className="text-[0.8rem]">{inquiry.createdDate}</div>
                    <div className="sm:hidden font-bold">Actions</div>
                    <div className="flex items-end space-x-3.5 justify-center">
